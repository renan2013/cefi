...
(function (global, factory) {
    ...
    (global = global || self, factory(global.VueSimpleCarousel = {}));
    ...
    ***************************************************************************** */
    ...
    function collectDataFromConstructor(vm, Component) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            if (!(Component.prototype instanceof Vue) && Object.keys(plainData).length > 0) {
                warn$1('Component class must inherit Vue or its descendant class ' +
    ...
    function forwardStaticMembers(Extended, Original, Super) {
        ...
        Object.getOwnPropertyNames(Original).forEach(function (key) {
            ...
            if (!hasProto$1) {
                ...
                if (!isPrimitive$1(descriptor.value) &&
                    superDescriptor &&
            ...
            if (process.env.NODE_ENV !== 'production' &&
                ...
                warn$1("Static property name '" + key + "' declared on class '" + Original.name + "' " +
    ...
    /* template */
    var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue-simple-carousel-container"},[_c('div',{staticClass:"vsc-scroller",on:{"touchstart":_vm.touchStart}},[_c('div',{ref:"items",staticClass:"vsc-items",class:{moving: _vm.moving},style:({width: ((_vm.itemsLength * (100 / _vm.itemsOnScreen)) + "%")})},[_vm._t("default")],2)]),(_vm.itemsLength > 1)?_c('div',{staticClass:"vsc-controls"},[_c('div',{staticClass:"arrow prev",class:{disabled: !_vm.hasPrev},on:{"click":_vm.previous}},[_vm._t("arrow-prev",[_vm._v("←")])],2),_c('div',{staticClass:"vsc-points"},_vm._l((_vm.points),function(point){return _c('div',{key:point,staticClass:"vsc-point",class:{current: _vm.currentIndex === point},on:{"click":function($event){return _vm.setCurrentIndex(point)}}})}),0),_c('div',{staticClass:"arrow next",class:{disabled: !_vm.hasNext},on:{"click":_vm.next}},[_vm._t("arrow-next",[_vm._v("→")])],2)]):_vm._e()])};
