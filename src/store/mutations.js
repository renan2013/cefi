                     ...
                     try {
                         ...
                         try {
                             ...
                             if (items[i].contenido) {
                                 ...
                                 /* local
                                                                  let ruta = "https://ceficr.com/bitweb/imagebank/" + documentos.lote + "/" + documentos.referencia + ".webp";
                                                                  publicacion.urlImg = ruta;
                                                                  ruta = "https://ceficr.com/bitweb/imagebank/" + documento.lote + "/" + documento.referencia + "sl.webp";
                         ...
                         try {
                             ...
                             if (items[i].contenido) {
                                 ...
                                 */
                                 ...
                                 ruta = state.raizUrl + "/bitweb/imagebank/" + documentos.lote + "/" + documentos.referencia + "sl.webp";
                                 //ruta = "https://ceficr.com/bitweb/imagebank/" + documentos.lote + "/" + documentos.referencia + "sl.webp";
